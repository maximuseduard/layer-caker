...
export async function GET(request: Request) {
    ...
    const darkVibrantBackground = data?.image?.metadata?.palette?.darkVibrant?.background ?? '#3B82F6';
            ...
            >
                ...
                <div tw="flex flex-row w-full h-full relative">
                    ...
                    <div tw="flex-1 flex items-center px-10">
                        <h1 tw="text-7xl tracking-tight leading-none text-white leading-tight">{text}</h1>
                    </div>
                    ...
                    {data.image && (
                        <div tw="flex w-[500px] h-[630px] overflow-hidden">
                            ...
                            <img src={urlFor(data.image.url!).width(500).height(630).url()} alt="" tw="w-full h-full object-cover" />
                        </div>
                    )}
                </div>
            </div>
