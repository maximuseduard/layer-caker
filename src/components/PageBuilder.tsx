...
export function PageBuilder({ content, documentId, documentType }: PageBuilderProps) {
    const blocks = useOptimistic<NonNullable<PAGE_QUERYResult>['content'] | undefined, NonNullable<PAGE_QUERYResult>>(
        content,
        (state, action) => {
